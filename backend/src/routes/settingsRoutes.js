...
const {
    ...
    getSystemSettings,
    updateSystemSetting,
    deleteSystemSetting,        // ✅ NEW
    getGradeRanges,
    updateGradeRange,
    deleteGradeRange,           // ✅ NEW
    getUsers,
    createUser,
    updateUser,
    deleteUser,
...
router.delete("/system-settings/:id", roleMiddleware("ADMIN"), deleteSystemSetting);   // ✅ NEW

// ==================== GRADE RANGES ====================
router.get("/grade-ranges", getGradeRanges);
router.put("/grade-ranges/:id", roleMiddleware("ADMIN"), updateGradeRange);
router.delete("/grade-ranges/:id", roleMiddleware("ADMIN"), deleteGradeRange);         // ✅ NEW
