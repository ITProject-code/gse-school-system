...
const getStudentDashboard = async (req, res) => {
    try {
        ...
        // Get the subject IDs the student is currently enrolled in
        const enrolledSubjectIds = enrolledSubjects.map(s => s.subject_id);

        // ========== GET GRADES - ONLY FOR ENROLLED SUBJECTS ==========
        let grades = [];
    ...
    try {
        ...
        for (const subject of subjectsResult.rows) {
            ...
            const gradeData = {
                ...
                grade: total.grade || 'F',
                is_complete: total.is_complete || false,
